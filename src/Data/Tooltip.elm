...
knownTooltips =
    [ ( portfolioStructureTip, "Struktura portfolia definuje požadované rozložení zůstatkové částky do půjček na základě ratingu. Můžete zvolit jedno ze tří předdefinovaných portfolií (konzervativní, balancované, progresivní) a podle potřeby jej s pomocí posuvníků upravit." )
    , ( buyFilterListTip, "Pravidla nákupu umožňují ignorovat některé položky (půjčky či participace) na tržišti. Daná položka bude ignorována pokud splní podmínky alespoň jednoho z Vámi definovaných pravidel." )
    , ( sellFilterListTip, "Pravidla prodeje určují které Vámi vlastněné participace má robot prodávat." )
    , ( buyFilterCreationTip, "Pravidla nákupu určují které položky na tržišti (půjčky či participace) mají být ignorovány. Daná položka bude ignorována pokud splní všechny podmínky pravidla. Pokud však zároveň splní všechny podmínky výjimky, ignorována nebude." )
