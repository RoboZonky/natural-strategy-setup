...
knownTooltips =
    ...
    , ( filterCreationTip, "Filtr specifikuje jednu nebo více podmínek určujících, kdy má být úvěr (či participace) ignorován. Daný úvěr (či participace) bude ignorován, pokud splní VŠECHNY podmínky, které zde zvolíte." )
    ]
