...
main = shakeArgs options $ do
    ...
    phony "deploy-stage" $ do
        deploy "/home/janhrcek/Devel/github.com/jhrcek/jhrcek.github.io/natural-strategy-setup"

    phony "deploy-prod" $ do
        deploy "/home/janhrcek/Devel/github.com/RoboZonky/robozonky.github.io/konfigurace-strategie"
